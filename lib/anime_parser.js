...
const BASE_URL = 'https://anitaku.io/';
const BASE_URL2 = 'https://anitaku.io/';
const ajax_url = 'https://ajax.gogocdn.net/';
const anime_info_url = 'https://anitaku.io/category/';
...
const seasons_url = 'https://anitaku.io/sub-category/';
...
export const scrapeAnimeDetails = async ({ id }) => {
  try {
    ...
    const animePageTest = await axios.get(`https://anitaku.io/category/${id}`);
...
export const scrapeWatchAnime = async ({ id }) => {
  try {
    ...
    const WatchAnime = await axios.get(`https://anitaku.io/${id}`);
