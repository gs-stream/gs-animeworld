...
const BASE_URL = 'https://gogoanime3.com.co/';
const BASE_URL2 = 'https://gogoanime3.com.co/';
const ajax_url = 'https://ajax.gogocdn.net/';
const anime_info_url = 'https://gogoanime3.com.co/category/';
...
const seasons_url = 'https://gogoanime3.com.co/sub-category/';
...
export const scrapeAnimeDetails = async ({ id }) => {
  try {
    ...
    const animePageTest = await axios.get(`https://gogoanime3.com.co/category/${id}`);
...
export const scrapeWatchAnime = async ({ id }) => {
  try {
    ...
    const WatchAnime = await axios.get(`https://gogoanime3.com.co/${id}`);
